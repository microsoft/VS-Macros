    ...
    public class MacrosToolWindow : ToolWindowPane
    {
        ...
        public void OnLoaded(object sender, System.Windows.RoutedEventArgs e)
        {
            if (!this.addedToolbarButton)
            {
                ...
                var a = ((CommandBars)window.CommandBars)[1].Controls;
                ...
                this.owningPackage.ImageButtons.Add((CommandBarButton)((CommandBars)window.CommandBars)[1].Controls[7]);
                this.owningPackage.ImageButtons.Add((CommandBarButton)((CommandBars)window.CommandBars)[1].Controls[12]);
