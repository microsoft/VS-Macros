...
namespace VSPackage1_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Company.VSPackage1.GuidList.guidVSPackage1CmdSet, (int)Company.VSPackage1.PkgCmdIDList.icecream2);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "sarah1.0", "Company.VSPackage1.VSPackage1Package");
